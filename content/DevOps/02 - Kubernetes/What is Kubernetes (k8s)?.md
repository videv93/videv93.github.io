...
source: "https://bytebytego.com/guides/what-is-k8s-kubernetes/"
author:
published:
created: 2026-08-27
...
[Edit on GitHub](https://github.com/ByteByteGoHq/system-design-101/blob/main/data/guides/what-is-k8s-kubernetes.md)k8s is a container orchestration system. It is used for container deployment and management. Its design is greatly impacted by Google’s internal system Borg.
...
## Liên kết
[[Kubernetes Architecture]] — bản mở rộng đầy đủ của các thành phần nêu ở trên · [[Kubernetes Workloads]] · [[Container Fundamentals]] · [[DevOps]]
